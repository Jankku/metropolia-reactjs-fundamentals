...
function App() {
  ...
  const fetchItems = () => {
    fetch('https://todolist-c4d07-default-rtdb.europe-west1.firebasedatabase.app/items.json')
  ...
  const deleteTodo = (id) => {
    fetch(
      `https://todolist-c4d07-default-rtdb.europe-west1.firebasedatabase.app/items/${id}.json`,
      {
        method: 'DELETE',
      }
    )
